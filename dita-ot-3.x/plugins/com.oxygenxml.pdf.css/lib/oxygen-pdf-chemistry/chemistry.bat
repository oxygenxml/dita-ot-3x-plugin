...
REM
%CHEMISTRY_JAVA% %XMX% %JAVA_ARG_LINE% -cp "%CLASSPATH%" com.oxygenxml.chemistry.OxygenPDFChemistry -install-dir %~dp0 %*
...
:dev 
	...
	CALL mvn -f "%~dp0..\..\..\pom.xml" exec:java -Dexec.mainClass="com.oxygenxml.chemistry.OxygenPDFChemistry" -Dexec.args="-install-dir %~dp0..\..\.. %*"
	SET ERROR_CODE=%ERRORLEVEL%	
GOTO :end
