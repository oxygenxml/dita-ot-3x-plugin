...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- PRE -->
  <xsl:template match="*[contains(@class,' topic/pre ')][contains(@outputclass, 'language-')]" name="topic.pre" use-when="function-available('version:getProductVersion')">
  ...
  <xsl:template match="xslthl:json_key" mode="xslthl">
    <span class="hl-json_key" style="color:#7263B9">
